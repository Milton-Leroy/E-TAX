...
@Component({
  selector: 'app-agency-agent-filter',
  standalone: true,
  imports: [CommonModule],
  template: `
    <button
      type="button"
      class="border border-banner-blue w-full flex items-center justify-between px-2 py-1 rounded bg-white
...
export class AgencyAgentFilterComponent {
